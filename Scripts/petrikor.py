...
with open("Archives\end.txt", "r+", encoding="utf-8") as endfile:
    ...
    if firstlg=="False":
        ...
        Wtext2 = "Versiyon: Deneyesel BETA"
    else:
        language=True
        Wtext1 = "Starting Up...Please Wait!"
        Wtext2 = "Version: Experimantal BETA"
...
while True:
    ...
    if language==True:
        Wtext1 = "Please Wait!"
        Wtext2 = "Version:ExperimantalBETA"
...
def welcome_email_func(names, Umail):
    ...
    # print(body)
    account = "onurvanced@gmail.com"
    mailll = smtplib.SMTP("smtp.gmail.com", 587)
    mailll.ehlo()
    mailll.starttls()
    mailll.login("onurvanced@gmail.com", "Onur1864")
    ...
    mailll.sendmail("onurvanced@gmail.com", Umail, server)
...
def Register_func():
    ...
    btn_continue= Button(register_window,text="HADİ KAYIDA BAŞLA!!!",command=register_personal_information_unit_func,cursor="hand2", bg="green", fg="white",font="Times 18 bold")
    btn_continue.place(x=30, y=337, width=390, height=50)
...
btn_now= Button(frame_btn,bd=5,text="ŞİMDİ! DOĞA için DÖNÜŞTÜR...",bg="dark green",fg="white",command=transform_for_nature_func,cursor="hand2",font="times 20 bold")
